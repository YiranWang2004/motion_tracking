...
from .mujoco_kinematics_wxyz import MujocoKinematics
from pathlib import Path
from .math_wxyz import (
...
_ASSET_DIR = Path(__file__).resolve().parents[3] / "config/g1/omnicontact"
KINEMATICS = MujocoKinematics(xml_path=(_ASSET_DIR / "g1_29dof_fk.xml").as_posix())
with open(_ASSET_DIR / "DefaultPose.yaml", "r") as f:
...
class CfGenLoco:
    ...
    def generate(
        ...
        *,
        ...
        from .builder import _TrajBuilder
        from .carrybox_base import CfGenBase
